        ...
        >
          {services.map((service) => (
            <motion.div
              ...
              className="p-10 bg-white border border-border-light hover:border-primary transition-all duration-300 ease-[cubic-bezier(0.25,0.1,0.25,1)] relative group rounded-2xl hover:shadow-elegant overflow-hidden"
            >
